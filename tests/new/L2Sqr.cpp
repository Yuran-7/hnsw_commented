...
// 设定 fvecs 文件路径
const string FVECS_FILE = "/home/huanzhu/ANNS/dataset/sift/sift_base.fvecs";
...
int main() {
    ...
    for (size_t i = 1; i < vectors.size(); i++) {
        float dist = l2space.get_dist_func()(query, vectors[i].data(), l2space.get_dist_func_param());
    ...
    cout << "计算 " << (vectors.size() - 1) << " 次 L2 距离耗时: " << duration << " 秒" << endl;
    return 0;
}
